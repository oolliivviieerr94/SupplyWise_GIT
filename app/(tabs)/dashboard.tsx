...
export default function DashboardScreen() {
  ...
  // Actions rapides (ajout de "Mes produits favoris")
  const quickActions = [
        ...
        <View style={styles.section}>
          ...
          <View style={styles.profileSummary}>
            ...
            <View style={styles.profileStat}>
              ...
              <Text style={styles.profileStatValue}>{userProfile.frequency_per_week}x/sem</Text>
            </View>
            <View style={styles.profileStat}>
              <Text style={styles.profileStatLabel}>Budget</Text>
              <Text style={styles.profileStatValue}>{userProfile.budget_monthly}€/mois</Text>
            </View>
          </View>

          {/* Bouton unique : ouvre l’onboarding en mode édition à l’étape 2 */}
          <TouchableOpacity
